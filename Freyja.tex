...
% logo
    \ifcase\style
        % case 0
            % UoG
                \newcommand\logoAFile{{\directoryA/logo_UoG_green.png}}
                \newcommand{\logoAHeightSpecification}{0.5 cm}
                \newcommand{\logoBHeightSpecification}{6 cm}
    \or
        % case 1
            % UoG
                \newcommand\logoAFile{{\directoryA/logo_UoG_grey.png}}
                \newcommand{\logoAHeightSpecification}{0.5 cm}
                \newcommand{\logoBHeightSpecification}{6 cm}
    \or
        % case 2
            \ifcase\institution
                % case 0 (UoG)
                    \newcommand\logoAFile{{\directoryA/logo_UoG_CERN_blue.png}}
                    \newcommand{\logoAHeightSpecification}{0.5 cm}
                    \newcommand{\logoBHeightSpecification}{6 cm}
            \or
                % case 1 (CERN)
                    \newcommand\logoAFile{{\directoryA/LogoOutline-Blue-04.png}}
                    \newcommand{\logoAHeightSpecification}{0.7 cm}
                    \newcommand{\logoBHeightSpecification}{2.5 cm}
            \or
                % case 2 (ATLAS)
                    \newcommand\logoAFile{{\directoryA/ATLAS_logo_CERN_blue.png}}
